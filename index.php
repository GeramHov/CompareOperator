  ...
  <div class="container">
    ...
    <form action="" method="get">
      <div id="showinput" class="d-flex">
        ...
        <!-- HIDDEN INPUT START -->
        <input class="searchinput w-75 rounded-1 font-italic" type="text" name="searchkey"
...
<section id="partners">
  ...
  <div class="container my-5">
    ...
    <form action="" method="get">
      <div id="showinput" class="d-flex">
        <input class="searchinputcomp w-75 rounded-1 font-italic" type="text" name="compsearchkey"
