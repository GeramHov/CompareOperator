...
--
-- Host: mysql
-- Generation Time: Apr 11, 2023 at 01:24 PM
...
INSERT INTO `feedback` (`id`, `message`, `note`, `tour_operator_name`, `user_id`) VALUES
(1, 'good company', 5, 'AirFrance', 1),
(3, 'fb', 3, 'AirFrance', 1),
(4, 'fdbvsd', 5, 'AirFrance', 1),
(5, 'fdbvsd', 5, 'American', 1),
(6, 'This company sucks!!!', 1, 'PabloReservas', 1);
...
(11, 'GastriteAir', 'https://www.gastrite.com/', 'TOUR_OPERATOR_ICON/gastrite.png'),
(12, 'PabloReservas', 'https://www.pablitto.com/', 'TOUR_OPERATOR_ICON/pabloreservas.png'),
(13, 'HakimFlight', 'https://www.hakim.com/', 'TOUR_OPERATOR_ICON/hakimflight.png'),
(14, 'MilkyWayzz', 'https://www.milky.com/', 'TOUR_OPERATOR_ICON/milkywayzz.png');
...
CREATE TABLE `users` (
  ...
  `image` varchar(255) NOT NULL DEFAULT 'profilephoto.png',
...
INSERT INTO `users` (`id`, `firstname`, `lastname`, `admin`, `email`, `password`, `image`, `banned`, `created_at`, `last_connection`) VALUES
(1, 'Gueram', 'Hovhannisyan', 1, 'geram.hov@gmail.com', '202cb962ac59075b964b07152d234b70', 'photo-profil.jpg', 0, NULL, '2023-04-11 07:56:49'),
(2, 'Baba', 'Yaga', 0, 'baba@yaga.com', '202cb962ac59075b964b07152d234b70', 'profilephoto.png', 0, NULL, '2023-04-11 07:33:45'),
(3, 'Marco', 'Polo', 0, 'marco@polo.com', '698d51a19d8a121ce581499d7b701668', 'profilephoto.png', 0, NULL, '2023-04-11 07:30:20'),
(4, 'Alessandro', 'Del Piero', 0, 'panther@panther.com', '81dc9bdb52d04dc20036dbd8313ed055', 'profilephoto.png', 0, NULL, '2023-04-11 07:30:20'),
(5, 'Buggs', 'Bunny', 0, 'bugs@bunny.com', '202cb962ac59075b964b07152d234b70', 'profilephoto.png', 0, NULL, '2023-04-11 07:30:20'),
(6, 'Tom', 'Jerry', 0, 'tom@tom.com', '698d51a19d8a121ce581499d7b701668', 'profilephoto.png', 0, NULL, '2023-04-11 07:30:20'),
(7, 'ab', 'ab', 0, 'ab@ab.com', '202cb962ac59075b964b07152d234b70', 'profilephoto.png', 0, '2023-04-11', '2023-04-11 07:40:51');
